<!doctype html>
 ...
 <head>
 <title>Swakarya Admin - Dashboard</title>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="manage-services.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    ...
                                    <p class="mt-5">
                                        <i class="si si-puzzle fa-3x text-white-op"></i>
                                    </p>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="manage-event-type.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                    ...
                                    <p class="mt-5">
                                        <i class="si si-energy fa-3x text-white-op"></i>
                                    </p>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="manage-gallery.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                     ...
                                     <?php 
                                            ...
                                            $query->execute();
                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                            $totalgallery=$query->rowCount();
                                    ?>
                                    <div class="ribbon-box"><?php echo htmlentities($totalgallery);?></div>
                                    <p class="mt-5">
                                        <i class="si si-picture fa-3x text-white-op"></i>
                                    </p>
                                    <p class="font-w600 text-white">Total Picture</p>
                                </div>
                            </a>
                        </div>
                        <!-- END Row #1 -->
                ...
                <div class="content">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        <!-- Row #1 -->
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="unread-feedback.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    <?php 
                                            $sql ="SELECT ID from tblfeedback where IsRead is null ";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                            $totalunreadfeedback=$query->rowCount();
                                    ?>
                                    <div class="ribbon-box"><?php echo htmlentities($totalunreadfeedback);?></div>
                                    <p class="mt-5">
                                        <i class="si si-envelope-letter fa-3x text-white-op"></i>
                                    </p>
                                    <p class="font-w600 text-white">Total Unread Feedback</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="read-feedback.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    <?php 
                                            $sql ="SELECT ID from tblfeedback where IsRead='1'";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                            $totalreadfeedback=$query->rowCount();
                                    ?>
                                    <div class="ribbon-box"><?php echo htmlentities($totalreadfeedback);?></div>
                                    <p class="mt-5">
                                        <i class="si si-envelope-open fa-3x text-white-op"></i>
                                    </p>
                                    <p class="font-w600 text-white">Total Read Feedback</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="payment-status.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                     <?php 
                                            $sql ="SELECT ID from tblpayment";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                            $totalpayment=$query->rowCount();
                                    ?>
                                    <div class="ribbon-box"><?php echo htmlentities($totalpayment);?></div>
                                    <p class="mt-5">
                                        <i class="si si-wallet fa-3x text-white-op"></i>
                                    </p>
                                    <p class="font-w600 text-white">Total Payment Made</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="cancel-requests.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                     <?php 
                                            $sql ="SELECT ID from tblbooking where CancelStatus='Pending' ";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                            $totalcancel=$query->rowCount();
                                    ?>
                                    <div class="ribbon-box"><?php echo htmlentities($totalcancel);?></div>
                                    <p class="mt-5">
                                        <i class="si si-exclamation fa-3x text-white-op"></i>
                                    </p>
                                    <p class="font-w600 text-white">Total Cancel Request</p>
                                </div>
                            </a>
                        </div>
                        <!-- END Row #1 -->

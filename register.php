...
<body>
	<div class="container">
			<form method="post" name="signup" class="login-email" onsubmit="return checkpass();">
				...
				<div class="input-group">
					<input type="text" name="mobno" placeholder="Mobile Number" required="true" maxlength="12" pattern="[0-9]+">
				</div>
				<div class="input-group">
					<textarea name="address" placeholder="Address" required="true" cols="30" rows="5"></textarea>
				</div>
				<div class="input-group">
